...
<div class="coInputHeader">
	...
	<?php echo text_field('milestone[name]', array_var($milestone_data, 'name'), 
		array('class' => 'title', 'id' => 'milestoneFormName', 'tabindex' => '1')) ?>
	</div>
	
	<div style="padding-top:5px">
		<?php if (isset ($projects) && count($projects) > 0) { ?>
			<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_select_workspace_div', this)"><?php echo lang('workspace') ?></a> - 
		<?php } ?>
		<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_tags_div', this)"><?php echo lang('tags') ?></a> - 
		<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_description_div', this)"><?php echo lang('description') ?></a> - 
		<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_options_div', this)"><?php echo lang('options') ?></a> - 
		<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_properties_div', this)"><?php echo lang('properties') ?></a>
		<?php if(!$milestone->isNew() && $project instanceof Project && $milestone->canLinkObject(logged_user(), $project)) { ?> - 
			<a href="#" class="option" onclick="og.toggleAndBolden('add_milestone_linked_objects_div', this)"><?php echo lang('linked objects') ?></a>
		<?php } ?>
	</div>
</div>
...
<div class="coInputMainBlock">
	...
	<?php if (isset ($projects) && count($projects) > 0) { ?>
	<div id="add_milestone_select_workspace_div" style="display:none">
	<fieldset>
	...
	<div id="add_milestone_tags_div" style="display:none">
	<fieldset>
...
<script type="text/javascript">
	Ext.get('milestoneFormName').focus();
</script>