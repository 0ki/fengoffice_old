...
<div class="hint">
  ...
  <div class="content">
    ...
    <ul>
      ...
      <li><a class="internalLink" href="<?php echo get_url('administration', 'members') ?>"><?php echo lang('members') ?></a> (<a class="internalLink" href="<?php echo owner_company()->getAddUserUrl() ?>"><?php echo lang('add user') ?></a>)</li>
