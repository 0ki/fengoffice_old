<?php if (user_config_option('show_pending_tasks_widget_context_help', true, logged_user()->getId())) {
	tpl_assign('helpDescription', lang('chelp pending tasks widget'));
	tpl_assign('option_name' , 'pending_tasks_widget');
