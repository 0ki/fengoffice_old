<?php
  ...
  /**
  * BaseMemberCustomProperty class
  * Written on Thu, 4 Oct 2009 14:51:09 -0300
  */
  abstract class BaseMemberCustomProperty extends DataObject {
    ...
    */
    function manager() {
      if(!($this->manager instanceof MemberCustomProperties )) $this->manager =  MemberCustomProperties::instance();
      return $this->manager;
    } // manager
  
  } // BaseMemberCustomProperty
