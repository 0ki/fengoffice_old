...
//    */
//    function manager() {
//      if(!($this->manager instanceof ObjectPermissions )) $this->manager =  ObjectPermissions::instance();
//      return $this->manager;
//    } // manager
//  
