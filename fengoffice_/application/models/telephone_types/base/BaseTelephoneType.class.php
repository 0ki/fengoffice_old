<?php
  ...
  /**
  * BaseTelephoneType class
  *
  * @author Diego Castiglioni <diego20@gmail.com>
  */
  abstract class BaseTelephoneType extends DataObject {
    ...
    */
    function manager() {
      if(!($this->manager instanceof TelephoneTypes)) $this->manager = TelephoneTypes::instance();
      return $this->manager;
    } // manager
