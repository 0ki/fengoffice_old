		...
		<div id="mainContent">
			...
			<div id="page_actions">
				<ul>
					...
					<li><a <?php echo $pageAction->getTarget() != null ? 'target="' .$pageAction->getTarget() . '"' : 'class="internalLink"' ?> href="<?php echo $page_action->getURL() ?>"><?php echo clean($page_action->getTitle()) ?></a></li>
					<?php } // foreach ?>
				</ul>
			</div>
			<?php } // if ?>
