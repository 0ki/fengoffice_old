...
INSERT INTO `<?php echo $table_prefix ?>user_ws_config_options` (`id`,`category_name`,`name`,`default_value`,`config_handler_class`,`is_system`,`option_order`,`dev_comment`) VALUES 
 ...
 (12,'task panel','tasksShowWorkspaces','1','BoolConfigHandler',0,0,''),
 (13,'task panel','tasksShowTime','1','BoolConfigHandler',0,0,''),
 (14,'task panel','tasksShowDates','1','BoolConfigHandler',0,0,''),
 (15,'task panel','tasksShowTags','1','BoolConfigHandler',0,0,''),
 (16,'task panel','tasksGroupBy','milestone','StringConfigHandler',0,0,''),
 (17,'task panel','tasksOrderBy','priority','StringConfigHandler',0,0,''),
 (18,'task panel','task panel status','1','IntegerConfigHandler',0,0,''),
 (19,'task panel','task panel filter','assigned_to','StringConfigHandler',0,0,''),
 (20,'task panel','task panel filter value','0:0','UserCompanyConfigHandler',0,0,''),
