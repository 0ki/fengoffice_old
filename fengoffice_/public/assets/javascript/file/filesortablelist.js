...
{
	col = document.getElementsByName('selected');
	boxes = col.length;
	txt = "";
	for (i = 0; i < boxes; i++) {
		if (col[i].checked) {
...
function goToProperties(baseurl) {	
...
function ts_makeSortable(table) {
	...
	for (var i=0; i < firstRow.cells.length; i++) {
		...
		if (cell.className != "unsortable" && cell.className.indexOf("unsortable") == -1) {
			cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this);return false;">'+txt+'<span class="sortarrow">&nbsp;&nbsp;<div class="noarrowicon" title="&darr;">&nbsp;&nbsp;&nbsp;&nbsp;</div></span></a>';
		}
	}
	alternate(table);
}
...
function ts_resortTable(lnk) {
	...
	if (span.getAttribute("sortdir") == 'down') {
			ARROW = '&nbsp;&nbsp;<div class="uparrowicon" title="&uarr;">&nbsp;&nbsp;&nbsp;&nbsp;</div>';
			newRows.reverse();
			span.setAttribute('sortdir','up');
	} else {
			ARROW = '&nbsp;&nbsp;<div class="downarrowicon" title="&darr;">&nbsp;&nbsp;&nbsp;&nbsp;</div>';
	...
	for (var ci=0;ci<allspans.length;ci++) {
		if (allspans[ci].className == 'sortarrow') {
			if (getParent(allspans[ci],"table") == getParent(lnk,"table")) { // in the same table as us?
				allspans[ci].innerHTML = '&nbsp;&nbsp;<div class="noarrowicon" title="&darr;">&nbsp;&nbsp;&nbsp;&nbsp;</div>';
			}
		}
	}
...
function alternate(table) {
	...
	for (var i = 0; i < tableBodies.length; i++) {
		...
		for (var j = 1; j < tableRows.length - 1; j++) {
