<?php return array(
	...
	'config category desc mailing' => 'Usa queste preferenze per configurare come OpenGoo gestisce l\'invio di  email. Puoi usare le opzioni configurazione fornite in php.ini o configurarlo affinché usi un altro server SMTP.',
	...
	'config option desc theme' => 'L\'uso dei temi consente di personalizzare l\'aspetto di OpenGoo. Premere Refresh per apportare le modifiche.',
	...
	'config option desc upgrade_check_enabled' => 'Se abilitato il sistema controllerà una volta al giorno la disponibilità di una versione aggiornata di OpenGoo disponibile per il download',
...
Code explanations: d = Day number (2 digits with leading zeros), D = Day name (three letters), j = Day number, l = Complete day name, m = Month number (with leading zeros), M = Month name (three letters), n = Month number, F = Complete month name, Y = Year (4 digits), y = Year (2 digits). Remember that you refresh is required to apply the changes.',
	...
	'cron event desc send_notifications_through_cron' => 'Abilitando questo evento le notifiche email saranno inviate via cron e non quando vengono generate da OpenGoo',
