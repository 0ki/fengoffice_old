<?php return array(
	...
	'error db backup' => '次のデータベースのバックアップを作成している間にエラーが発生: {0}',
	'backup command failed' => 'バックアップのコマンドの実行に失敗しました。定数MYSQLDUMP_COMMANDを確認してください。',
	'success db backup' => 'バックアップの作成に成功しました。',
	'error create backup folder' => 'バックアップのフォルダーの作成している間にでエラーが発生しました。バックアップを完了できません。',
	'error delete backup' => 'データベースのバックアップを削除している間にエラーが発生しました。',
