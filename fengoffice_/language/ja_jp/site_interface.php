<?php return array(
	'new OpenGoo version available' => '新しいバージョンのOpenGooが利用できます。 <a class="internalLink" href="{0}">詳細はこちらから</a>.',
	'my tasks' => '私のタスク',
	...
	'upgrade is not available' => 'ダウンロード可能な新しいバージョンのOpenGooはありませんでした。',
	...
	'too many tasks to display' => '表示するタスクが多すぎて、もっとも最近の500のタスクだけを表示しています。タスクを正しく表示して、この警告を消すにはワークスペース、タグ、タスクのフィルタ、状態でタスクをフィルタしてください。',
	...
	'new account step update account info' => 'このページの右上にあるアカウントのリンクをクリックして、自分の個人情報の更新とパスワードの変更をしてくださ。',
	...
	'new account step configuration info' => 'OpenGooの一般的な設定、メールの環境設定、モジュールの有効・無効、その他のオプションといった<a class="internalLink" href="{0}">管理</a>を行います。',
