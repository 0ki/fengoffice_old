<?php return array(
	...
	'system error message' => '申し訳ありませんが、致命的なエラーによってOpenGooがあなたの要求を実行できませんでした。 エラーレポートを管理者に送りました。',
	'execute action error message' => '申し訳ありませんが、OpenGooがあなたの要求を実行できませんでした。 エラーレポートを管理者に送りました。',
