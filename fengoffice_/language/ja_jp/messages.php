<?php
  ...
  */
  ...
  return array(
	...
	'success update config category' => '{0}の設定値を更新しました。',
	...
	'success unclassify emails' => "{0}通のメールを正常に未分類にしました。",
	'error unclassify emails' => "{0}通のメールを未分類にする処理にエラー",
	...
	'success update billing values' => '時間帯課金の値が正常に更新されました: {0}件のエントリが変更されました。',
	...
	'error cannot link object to self' => '自身にオブジェクトをリンクできません。',
	...
	'confirm delete mail account' => '警告: このアカウントを削除すると全てのメールが削除されます。このメールアカウントを本当に削除しても良いですか？',
	...
	'log unarchive projectmessages' => '\'{0}\'のアーカイブを解除しました。',
	'log comment projectmessages' => '\'{0}\'にコメントしました。',
	'log comment projectmessages data' => '\'{0}\'にコメントしました。',
	'log subscribe projectmessages' => '\'{0}\'を購読を開始しました。',
	...
	'log unarchive projectevents' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive comments' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projectmilestones' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projecttasklists' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projecttasks' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projectforms' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projectfiles' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive projectwebpages' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive contacts' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive companies' => '\'{0}\'のアーカイブを解除しました',
	...
	'log unarchive mailcontents' => '\'{0}\'のアーカイブを解除しました。',
	...
	'log unarchive timeslots' => '\'{0}\'のアーカイブを解除しました。',

	'log login users data' => 'ユーザ{0}次のIPアドレスからログイン: {1}',
	...
	'error markasread objects' => '{0}オブジェクトを既読に出来ませんでした。',
	...
	'recipient must be specified' => 'メールの宛先を指定してください。',
	'mail is being sent' => 'メールを送信しました...',
	...
	'some objects could not be linked' => '{0}個のオブジェクトはパーミッション制限のためリンクできませんでした。',
	'user cannot link objects' => 'このオブジェクトにリンクをする権限を持っていません。',
	'ie browser outdated' => 'お使いのブラウザは公式にはサポートされていません。良い経験のために、ブラウザをアップグレードしてください。',

	'short search query warning' => '検索文字列が短すぎます。"<b>{0}</b>"で始まる単語を検索するには"<b>{0}*</b>"を試してみてください。',
	'no attachments found for email' => 'メールに添付ファイルはありません。',

	'success reset gui state' => 'ユーザインタフェースを正常にリセットしました。',
	'reset gui state' => 'ユーザインタフェースをリセット',
