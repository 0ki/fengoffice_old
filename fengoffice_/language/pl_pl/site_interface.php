<?php
  ...
  */
  ...
  return array(
    ...
    'footer powered' => 'Stworzone przez <a target="_blank" href="{0}">{1}</a>',
  ...
  'administrator options' => 'Opcje administracyjne',
  ...
  'pending tasks' => 'Zadanie w realizacji',
