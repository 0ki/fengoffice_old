<?php return array(
	'new OpenGoo version available' => 'Доступна новая версия OpenGoo. <a class="internalLink" href="{0}" onclick="{1}">Подробнее...</a>.',
	'my tasks' => 'Мои задачи',
	...
	'import contacts from csv' => 'Импортировать контакты с CSV-файла',
	'import' => 'Импорт',
	'file not exists' => 'Файл не найден',
	'field delimiter' => 'Разделитель полей',
	'first record contains field names' => 'Первая запись содержит имена полей',
	'import contact success' => 'Успешный импорт контакта',
	'contact fields' => 'Поля контакта',
	'fields from file' => 'Поля из файла',
	'you must match the database fields with file fields before executing the import process' => 'Поля базы данных с полями файла перед выполнением импорта должны совпадать.',
	'import result' => 'Результаты импорта',
	'contacts succesfully imported' => 'Контакт успешно импортирован',
	'contacts import fail' => 'Ошибка импорта контакта',
	'contacts import fail help' => 'Процесс импорта может не удасться из-за существующих данных в базе данных, таких как имя или адрес электронной почты и т.п.',
	...
	'pause time cannot be negative' => 'Время на паузе не может быть отрицательным',
	'task timeslots' => 'Задачи временных интервалов',
	'all timeslots' => 'Задачи и общие временные интервалы',
	'print report' => 'Печать отчёта',
	'pause time cannot exceed timeslot time' => 'Время на паузе не должно превышать временной интервал',
