<?php
  ...
  */
  ...
  return array(
    ...
    'new account step1' => 'Шаг 1-ый: Информация о компании',
    ...
    'new account step2' => 'Шаг 2-ой: Добавление сотрудников',
    ...
    'new account step3' => 'Шаг 3-ий: Добавление дочерней организации и её сотрудников',
    ...
    'new account step4' => 'Шаг 4-ый: Новый проект',
    ...
    'update contact' => 'Изменить контакт',
  	'update picture' => 'Изменить изображение',
  ...
  'can read contacts' => 'Разрешено спросматривать список контактов',
  ...
  'new mail account' => 'Новая учётная запись почты',
  ...
  'success close timeslot' => 'ВИнтервал времени закрыт',
  ...
  'workspace permamanent delete' =>  'Когда проект удаляется, следующее сожержимое <b>теряется навсегда</b>',
