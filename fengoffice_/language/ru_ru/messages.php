<?php return array(
	...
	'company dnx' => 'Выбранная организация не существует',
	...
	'success add handis' => 'Handins обновлены',
	...
	'success update company permissions' => 'Полномочия компаниии успешно обновлены. {0} записей обновлено',
	...
	'error link object' => 'Не удалось связать объект(ы)',
	...
	'error check mail' => 'Не удалось проверить акаунт \'{0}\': {1}',
	...
	'confirm delete company logo' => 'Вы уверены, что хотите удалить этото логотип?',
	...
	'execute action error message' => 'Приносим извинения, в настоящий момент OpenGoo не в состоянии выполнить Ваш запрос. Отчет об ошибке послан администратору.',
	...
	'log trash projectevents' => '\'{0}\' перемещено в корзину',
	'log untrash projectevents' => '\'{0}\' восстановлено из корзины',
	'log trash comments' => '\'{0}\' перемещено в корзину',
	'log trash projectmilestones' => '\'{0}\' перемещено в корзину',
	'log trash projecttasklists' => '\'{0}\' перемещено в корзину',
	'log trash projecttasks' => '\'{0}\' перемещено в корзину',
	'log trash projectforms' => '\'{0}\' перемещено в корзину',
	'log untrash comments' => '\'{0}\' восстановлено из корзины',
	'log untrash projectmilestones' => '\'{0}\' восстановлено из корзины',
	'log untrash projecttasklists' => '\'{0}\' восстановлено из корзины',
	'log untrash projecttasks' => '\'{0}\' восстановлено из корзины',
	'log untrash projectforms' => '\'{0}\' восстановлено из корзины',
	'log untrash projectfiles' => '\'{0}\' восстановлено из корзины',
	'log untrash projectfilerevisions' => '\'{0}\' восстановлено из корзины',
	'log untrash projectwebpages' => '\'{0}\' восстановлено из корзины',
	'log untrash contacts' => '\'{0}\' восстановлено из корзины',
	'log untrash companies' => '\'{0}\' восстановлено из корзины',
	'log untrash mailcontents' => '\'{0}\' восстановлено из корзины',
	'log untrash timeslots' => '\'{0}\' восстановлено из корзины',
	'log trash projectfiles' => '\'{0}\' перемещено из корзину',
	'log trash projectfilerevisions' => '\'{0}\' перемещено из корзину',
	'log trash projectwebpages' => '\'{0}\' перемещено из корзину',
	'log trash contacts' => '\'{0}\' перемещено из корзину',
	'log trash companies' => '\'{0}\' перемещено из корзину',
	'log trash mailcontents' => '\'{0}\' перемещено из корзину',
	'log trash timeslots' => '\'{0}\' перемещено из корзину',
