<?php
  ...
  */
  ...
  return array(
    ...
    'company dnx' => 'Запрошенная компания отсутствует в базе данных',
    ...
    'define project folders' => 'В этом проектк нет папок. Пожалуйста, создайте папки, чтобы продолжить работу',
    ...
    'error link object' => 'Не удалось связать объект',
