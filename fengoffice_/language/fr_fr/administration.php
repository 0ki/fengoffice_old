<?php return array(
	...
	'config category desc general' => 'Paramètres principaux de Intranet.',
	...
	'config option desc theme' => 'Utilisez les thèmes pour change l\'apparence de Intranet',
	'config option name upgrade_check_enabled' => 'Activer la vérification de mise à jour',
	'config option desc upgrade_check_enabled' => 'Si oui, le système vérifiera chaque jour s\'il existe une nouvelle version de Intranet à télécharger',
	...
	'user ws config option name show late tasks and milestones widget' => 'Afficher le module des tâches et Etapes en retard ',
	...
	'config category desc modules' => 'Utilisez ces paramètres pour activer ou désactiver les modules de Intranet. Désactiver un module le retirera seulement de l\'interface graphique sans affecter les permissions aux utilisateurs pour créer ou éditer des contenus.',
...
Ces valeurs ne s\'appliquent qu\'aux utilisateurs n\'ayant pas encore modifié leurs options. ',
	...
	'config option name sent_mails_sync' => 'Autoriser la synchronisation IMAP pendant un envoi Emails depuis Intranet',
	'config option name check_spam_in_subject' => 'Vérifier le SPAM dans le Sujet de l\'Email',
	'config option name block_login_after_x_tries' => 'Bloquer le Login aprés 5 essais infructeux',
	...
	'user config option name view deleted accounts emails' => 'Afficher les Comptes Emails supprimés',
	'user config option name block_email_images' => 'Bloquer les Images dans les Emails',
	'user config option name attach_docs_content' => 'Joindre le Contenu des Fichiers',
	'user config option name show_emails_as_conversations' => 'Afficher les Emails comme des Conversations',
	...
	'user config option name create_contacts_from_email_recipients' => 'Créer un Contact à partir des Emails reçus',
	'user config option name mail_drag_drop_prompt' => 'Classer les Pièces Jointes pendant les actions de Glisser-Déposer?',
	'user config option name hide_quoted_text_in_emails' => 'Masquer le texte des E-mails lors de la visualisation',
	'user config option name mail_account_err_check_interval' => 'Intervalle de vérification des Erreurs dans les Emails',
	'user config option name classify_mail_with_conversation' => 'Classer les Emails par leur Conversation',
	...
	'user selector permissions help' => 'Clicquer sur un Groupe ou sur un Collaborateur pour modifier les permissions',
	...
	'config option desc repeating_task' => 'hes répétitives seront affichés individuellement, et non pas comme une simple tâche',
