<?php return array(
	...
	'config category desc general' => 'Paramètres principaux d\'Feng Office.',
	...
	'config option desc theme' => 'Utilisez les thèmes pour change l\'apparence d\'Feng Office',
	'config option name upgrade_check_enabled' => 'Activer la vérification de mise à jour',
	'config option desc upgrade_check_enabled' => 'Si oui, le système vérifiera chaque jour s\'il existe une nouvelle version d\'Feng Office à télécharger',
	...
	'config category desc modules' => 'Utilisez ces paramètres pour activer ou désactiver les modules d\'Feng Office. Désactiver un module le retirera seulement de l\'interface graphique sans affecter les permissions aux utilisateurs pour créer ou éditer des contenus.',
	...
	'cron events info' => 'Les évènements programmés vous permettent d\'exécuter périodiquement des tâches dans Feng Office sans être connecté au système. Pour activer des évènements programmés, vous devez configurer une tâche cron qui exécute périodiquement le fichier "cron.php" situé à la racine d\'Feng Office. La périodicité à laquelle une tâche cron s\'exécute détermine le moment ou les évènements programmés seront exécutés. Par exemple, si vous programmez l\'exécution d\'une tâche cron toutes les 5 minutes, et que vous configurez un évènement programmé pour gérer des mises à jour chaque minute, les mises à jour se feront toutes les 5 minutes seulement. Demandez à votre administrateur système ou à votre hébergeur pour aller plus loin avec les tâches cron (Vous pouvez aussi demander des exemples sur le forum d\'Feng Office).',
	...
	'cron event desc check_upgrade' => 'Cet évènement programmé vérifiera la disponibilité de nouvelles versions d\'Feng Office.',
	...
	'cron event desc backup' => 'Si cet évènement est actif, Feng Office sera sauvegardé régulièrement. Le propriétaire de l\'installation pourra télécharger des sauvegardes grâce au panneau d\'administration. Les sauvegardes d\'Feng Office sont conservées sous forme de fichier zip dans le répertoire \'tmp/backup\'',
