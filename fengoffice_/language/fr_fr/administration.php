<?php return array(
	...
	'cron event desc check_mail' => 'Cet évènement programmé relèvera les nouveaux messages de tous les comptes courriels du système.',
	...
	'config option desc user_email_fetch_count' => 'Nombre de messages à récupérer quand l\'utilisateur clique sur le bouton "Relever les messages". Utiliser une valeur importante peut provoquer des erreurs de dépassement limite de temps. Utilisez 0 pour aucune limite. Notez que cela ne peut affecter la remontée des courriels au travers du \'cron\' (programmateur d\'évènements).',
	...
	'user ws config option name view deleted accounts emails' => 'Afficher les messages des comptes de courriel supprimés',
	'user ws config option desc view deleted accounts emails' => 'Vous permet d\'afficher les messages des comptes de courriel supprimés (pour utiliser cette fonction,  quand vous supprimez votre compte, vous devez choisir de ne pas supprimer les messages)',
