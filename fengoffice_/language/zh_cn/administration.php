<?php return array(
	...
	'can manage time' => '可以管理时间',
	'can add mail accounts' => '可以添加邮件账户',
	'add a parameter to template' => '为此模板添加一个参数',
	'parameters' => '参数',
	...
	'user ws config option name drag_drop_prompt' => '拖放到工作区时要执行的动作',
	'drag drop prompt option' => '提醒用户作出一个动作',
	'mail drag drop classify option' => '分类附件',
	'mail drag drop dont option' => '不分类附件',
	'user ws config option name show_emails_as_conversations' => '以交谈形式显示电子邮件',
	'user ws config option name search_engine' => '检索引擎',
