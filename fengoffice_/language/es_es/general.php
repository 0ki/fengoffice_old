<?php return array(
	...
	'wizard new customer' => 'En un espacio de trabajo podrás compartir y centralizar toda la información de un Cliente.<br />Se puede crear o buscar un espacio o sub-espacio de trabajo desde el panel de la izquierda.',
	
	'wizard new project title' => 'Agregar un espacio de trabajo para un Proyecto',
   	'wizard new project' => 'En un espacio de trabajo podrás compartir y centralizar toda la información de un Proyecto.<br />Se puede crear o buscar un espacio o sub-espacio de trabajo de un proyecto desde el panel de la izquierda.',
