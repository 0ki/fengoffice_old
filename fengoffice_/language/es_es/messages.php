<?php
  ...
  */
  ...
  return array(
    ...
    'log add contacts' => '\'{0}\' asignado al área de trabajo',
    'log edit contacts' => '\'{0}\' cambió su rol',
    'log delete contacts' => '\'{0}\' eliminado del área de trabajo',
	...
	'error cannot set workspace as parent' => 'No se puede establecer el área de trabajo \'{0}\' como padre, demasiados niveles',
