<?php return array(
	...
	'user created your account' => '{0} ha creado una nueva cuenta en Feng Office para ud.',
	'visit and login' => 'Por favor, visite {0} y acceda con',
        'need to set up your new password' => 'Sólo tiene que ingresar su nueva contraseña siguiendo este enlace:',
        'visit feel free to log in' => 'Por favor visite {0} y registrese con su nombre de usuario {1} o con su dirección de correo electrónico {2}',    
	...
	'new notification weblink desc' => 'Un nuevo enlace web \'{0}\' ha sido añadida por {1}',
