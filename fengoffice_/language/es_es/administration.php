<?php return array(
	...
	'can manage contacts' => 'Puede modificar y editar todos los contactos',
	...
	'user ws config option name show dashboard info widget' => 'Mostrar widget de descripción del espacio',
	...
	'user ws config option desc date_format' => 'Formato en que se muestran las fechas. Códigos: d = Día (2 dígitos, con ceros), D = Nombre del día (tres letras), j = Día, l = Nombre del día completo, m = Mes (con ceros), M = Nombre del mes (tres letras), n = Mes, F = Nombre del mes completo, Y = Año (4 dígitos), y = Año (2 dígitos).',
	'user ws config option name descriptive_date_format' => 'Formato de fecha descriptivo',
	'user ws config option desc descriptive_date_format' => 'Formato utilizado para las fechas, con descripción. Códigos: Idem a \'Formato de fecha\'',
	...
	'cron event desc check_upgrade' => 'Este evento de Cron verifica la existencia de nuevas versiones de OpenGoo.',
	...
	'backup config warning' => 'Advertencia: Sus directorios config y tmp no serán respaldados.',
	'cron event name send_notifications_through_cron' => 'Enviar notificaciones a través de cron',
	'cron event desc send_notifications_through_cron' => 'Si este evento está habilitado notificaciones de correo serán enviadas a través del cron y no al ser generadas por Opengoo.',
	'cron event name backup' => 'Respaldar OpenGoo',
	'cron event desc backup' => 'Si este evento está habilitado OpenGoo será respaldado períodicamente. El dueño de la instalación podrá desgargar respaldos a través del panel de Administración. Los respaldos de Opengoo se almacenan como archivos zip en el directorio \'tmp/backup\'',
