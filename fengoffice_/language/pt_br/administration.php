<?php return array(
	...
	'user ws config option desc show_context_help' => 'Seleccione se pretende visualizar sempre a Ajuda, nunca vê-la, ou vê-la até que cada caixa é fechada.',
	...
	'cron event name backup' => 'Back Up OpenGoo',
	'cron event desc backup' => 'Se o evento for ativado OpenGoo terá back up periodicamente. O proprietário da instalação será capaz de fazer download dos backups através do Painel de Administração. Os backups do OpenGoo são mantidos como um arquivo zip no diretório \'tmp / backup\'.',
