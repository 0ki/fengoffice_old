<?php return array(
	...
	'user ws config option name displayed events amount' => 'Número de eventos apresentados',
	'user ws config option desc displayed events amount' => 'O número de eventos por dia que são mostrados n0 relato do mês',
	...
	'user ws config option name show_file_revisions_search' => 'Veja revisões de arquivos ao executar pesquisas',
...
{0}',
	...
	'user ws config option name attach_to_notification' => 'Anexar documentos a notificações',
	'user ws config option desc attach_to_notification' => 'Quando ativado, por padrão, a opção de enviar o documento dentro das notificações está marcada.',
	...
	'user config option desc sendEmailNotification' => 'Se configurado, envia um email de notificação para o novo  Usuário.',
	'config option name can_assign_tasks_to_companies' => 'Pode designar tarefas para empresas',
	'config option desc can_assign_tasks_to_companies' => 'Se ativado, em seguida, as empresas irão aparecer no seletor  "atribuído a" ao adicionar/editar tarefas.',
	'config option name use_object_properties' => 'Usar propriedades de objetos',
	'config option desc use_object_properties' => 'Habilitar esta opção permite que você defina propriedades personalizadas (chave - valor) para cada objeto.',
	'user config option name access_member_after_add' => 'Acesse o novo membro após sua criação.',
	'user config option desc access_member_after_add' => 'Se você habilitar esta opção, depois de criar um espaço de trabalho, cliente, etc, ele será selecionado no painel da esquerda (esta opção só funciona se "Lembre acessar membro ou não membro, quando se criou" está habilitado).',
	'user config option name access_member_after_add_remember' => 'Lembre de acessar membro ou não membro, quando for criado',
	...
	'user config option desc add_task_default_reminder' => 'Por padrão crie lembretes quando você cria tarefas',
	'user config option name add_task_autoreminder' => 'Criar lembretes automáticos para outros destinatários quando se edita uma tarefa',
	'user config option desc add_task_autoreminder' => 'Ative essa opção para criar automaticamente auto-lembretes quando eu editar uma tarefa atribuída a alguém que já não tem um lembrete configurado',
	'user config option name add_self_task_autoreminder' => 'Crie lembretes automáticos ao editar minhas tarefas',
	'user config option desc add_self_task_autoreminder' => 'Ative esta opção se você deseja criar automaticamente auto-lembretes ao editar minhas tarefas que não têm mais um lembrete configurado',
	'user config option name add_event_autoreminder' => 'Crie lembretes automáticos durante a edição de um evento',
	'user config option desc add_event_autoreminder' => 'Ative esta opção se você deseja criar autotmaticamente auto-lembretes se você editar um evento que não tem mais um lembrete configurado',
	'user config option name autoassign_events' => 'AutoAssinar eventos',
	...
	'user config option desc event_send_invitations' => 'Ative esta opção se você quer ter a opção "Enviar convites" ativado por padrão quando você cria um evento',
	'user config option name event_subscribe_invited' => 'Assinar usuários convidados',
	'user config option desc event_subscribe_invited' => 'Ative esta opção se você quer ter a opção "Assinar Usuários Convidados" ativado por padrão quando você cria um evento',
