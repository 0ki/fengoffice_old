<?php return array(
	...
	'config option desc upgrade_check_enabled' => 'Se "Sim" o sistema vai buscar uma vez por dia se há novas versões do Feng Office disponível para download',
	...
	'config option name detect_mime_type_from_extension' => 'Detectar tipo MIME de extensão',
	'config option desc detect_mime_type_from_extension' => 'Permitir detectar tipo MIME do arquivo por sua extensão',
	...
	'user ws config option name create_contacts_from_email_recipients' => 'Criar contactos de destinatários de e-mail',
