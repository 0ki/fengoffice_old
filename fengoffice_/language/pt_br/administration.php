<?php return array(
	...
	'config option desc password_numbers' => 'Quantidade de caracteres númericos exigidos para a Senha',
	...
	'user ws config option name show getting started widget' => 'Exibir Quadro de ínicio de uso do Sistema',
	...
	'cron event desc send_notifications_through_cron' => 'Se este evento for ativado notificações por e-mail será enviado através da tarefa agendada, e não quando gerados por OpenGoo.',
	'cron event name backup' => 'BackUp OpenGoo',
	'cron event desc backup' => 'Se o evento for ativado OpenGoo terá BackUp periodicamente. O proprietário da instalação será capaz de fazer download dos backups através do Painel de Administração. Os backups do OpenGoo são mantidos como um arquivo zip no diretório \'tmp / backup\'.',
	...
	'user ws config option name draft_autosave_timeout' => 'Intervalo de autosalvamento de rascunhos',
	'user ws config option desc draft_autosave_timeout' => 'Segundos entre cada operação de AutoSalvamento para rascunhos de Emails (0 para desativar o autosalvamento)',
