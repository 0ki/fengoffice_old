  ...
  return array(
	...
	'check to include sub ws' => 'Check this to include sub workspaces in the url',
  	...
  	'week number x' => 'Week {0}',
        ...
        'must enter an calendar link' => 'Must enter an calendar link',
        ...
        'success add sync' => 'Synchronization successfully',
        'success edit account gmail' => 'Gmail account properly modified',
        'success add account gmail' => 'Gmail account successfully created',
        'must enter a account gmail' => 'Must enter a account Gmail',
        'must enter the password gmail' => 'Must enter the password of Gmail',
        'untitle event' => 'Untitle event',
        'click sincronizar' => 'Click here if you want Feng synchronize events with Google Calendar',
        'feng calendar' => 'Feng Calendar',
        'import calendars' => 'Import',
        'account has already' => 'Account has already been entered',
        'sync event feng' => 'Synchronize all events Feng',
