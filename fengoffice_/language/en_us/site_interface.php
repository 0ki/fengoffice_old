...
// Contact import
	...
	'contacts succesfully imported' => 'Persons succesfully imported',
	'contacts import fail' => 'Import failed for persons',
	...
	'import contacts from vcard' => 'Import persons from a VCard file',
	'select a vcard file to load its data' => 'Select a VCard file (.vcf) to run the import.',
	'you can tag the contacts before running the import' => 'You can tag the persons before running the import.',
	'you must select the contacts from the grid' => 'You must select the persons you want to export.',
	'vcard successfully created' => 'VCard successfully created, {0} persons exported.',

// Contact export
  	'export contacts to csv' => 'Export persons to .csv file',
	'export' => 'Export',
	'fields to export' => 'Information to export',
	'success export contacts' => 'Persons successfully exported',
...
//Email
  ...
  'no contacts to add' => 'No persons to add.',
...
//Checkout
  ...
  'can read contacts' => 'Can read persons',
  'can write contacts' => 'Can write persons',
