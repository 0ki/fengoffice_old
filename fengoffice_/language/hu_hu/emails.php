<?php return array(
	...
	'due_date reminder notification task' => 'Feladat határidő figyelmeztetés',
	'due_date task reminder desc' => 'A "{0}" feladat "{1}"-n lejár és még mindig függőben van',
	'due_date reminder notification milestone' => 'Mérföldkő határidő figyelmeztetés',
	'due_date milestone reminder desc' => 'A "{0}" mérföldkő "{1}"-n lejár és még mindig függőben van',
	'start reminder notification event' => 'Esemény figyelmeztetás',
